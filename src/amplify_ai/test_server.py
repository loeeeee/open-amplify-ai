...
from amplify_ai.server import app
...
def test_get_models_success(mocker):
    ...
    mocker.patch("amplify_ai.server.requests.get", return_value=mock_response)
...
def test_chat_completions_success(mocker):
    ...
    mocker.patch("amplify_ai.server.requests.post", return_value=mock_response)
...
def test_chat_completions_streaming(mocker):
    ...
    mocker.patch("amplify_ai.server.requests.post", return_value=mock_cm)
...
def test_chat_completions_custom_params(mocker):
    ...
    mocker.patch("amplify_ai.server.requests.post", side_effect=fake_post)
...
def test_upload_file_success(mocker):
    ...
    post_mock = mocker.patch("amplify_ai.server.requests.post", return_value=init_mock)
    put_mock = mocker.patch("amplify_ai.server.requests.put", return_value=s3_mock)
...
def test_upload_file_init_failure(mocker):
    ...
    mocker.patch("amplify_ai.server.requests.post", return_value=init_mock)
...
def test_retrieve_file_content_success(mocker):
    ...
    mocker.patch("amplify_ai.server.requests.post", return_value=api_mock)
    ...
    mocker.patch("amplify_ai.server.requests.get", return_value=content_mock)
...
def test_delete_thread_success(mocker):
    ...
    mocker.patch("amplify_ai.server.requests.delete", return_value=mock_response)
...
def test_retrieve_vector_store_success(mocker):
    ...
    mocker.patch("amplify_ai.server.requests.get", return_value=tags_mock)
    mocker.patch("amplify_ai.server.requests.post", return_value=files_mock)
